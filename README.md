...
>  Caution: This application requires an OpenAI API Key, and it requires linking a paid account, and charges are based on a pay-as-you-go system calculated by how much you use it
